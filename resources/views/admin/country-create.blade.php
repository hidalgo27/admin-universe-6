...
<div class="row">
    <div class="col-3">
        <div class="col">
            <p class="font-weight-bold text-secondary small pb-1 mb-2">CountrY Thumbnail Image<span class="badge badge-warning">800x900 PX</span></p>
            <form method="post" action="{{route('admin_countries_imagen_getFile_path')}}" enctype="multipart/form-data"
        ...
        <div class="col">
            ...
            <form method="post" action="{{route('admin_countries_slider_getFile_path')}}" enctype="multipart/form-data"
    ...
    <div class="col-9">
        <form action="{{route('admin_countries_store_path')}}" method="post">
            @csrf
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label class="font-weight-bold text-secondary small" for="txt_country">Country</label>
                        <input type="text" name="txt_country" class="form-control font-weight-bold" id="txt_country" placeholder="" value="{{old('txt_country')}}">
                    </div>
                </div>
            </div>
...
{{--            </div>--}}
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-group">
                        <textarea class="textarea-package" name="txta_recommend"></textarea>
                    </div>
                </div>
            </div>
...
{{--            </div>--}}
            ...
            <div class="row mb-3">
                <div class="col text-center">
                    ...
                    <input type="text" name="id_blog_file" id="imagen">
                    <input type="text" name="id_blog_file2" id="imagenes">
                    <input type="text" name="imagen_seo2" id="imagen_seo2">
                    <input type="text" name="seo_atributos" id="seo_atributos">
                    <button type="submit" class="btn btn-primary font-weight-bold">Create Country</button>
                </div>
            </div>
        </form>
    </div>
        ...
        $("#dropzone_countries").dropzone({
            ...
            removedfile: function(file){
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "{{ route('admin_countries_slider_getFile_path') }}",
                    data: dataString,
        ...
        $("#dropzone_imagen").dropzone({
            ...
            removedfile: function(file){
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "{{ route('admin_countries_imagen_deleteFile_path') }}",
                    data: dataString,
                    success: function (data) {
                        console.log("File has been successfully removed!!");
                    },
